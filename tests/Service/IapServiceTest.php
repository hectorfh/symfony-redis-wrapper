...
use IpartnersBundle\Service\IapService;
...
use IpartnersBundle\HttpClient\IapHttpClient;
 ...
 * Time: 4:00 PM
 */
class IapServiceTest extends IpartnersBaseTest
{
    ...
    public function test_jwt_ok() {
        ...
        $googleAuthService = $this->getMockBuilder('IpartnersBundle\\Provider\\Google\\Service\\GoogleAuthService')->disableOriginalConstructor()->getMock();
